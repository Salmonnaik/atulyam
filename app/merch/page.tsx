    ...
    <>
      ...
      <main className="relative z-10">
        <PageHero
          ...
          stat1={{ n: `${MERCH.length}`, u: "Items" }}
          stat2={{ n: "Free", u: "Shipping ₹999+" }}
          stat3={{ n: "100%", u: "Cosmic Quality" }}
        />
        ...
        {cart.length > 0 && (
          ...
          >
            ...
            <span className="font-mono text-[0.68rem] tracking-[2px] font-bold text-black">
            ...
            {MERCH.map((item, i) => (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `radial-gradient(circle at 50% 0%,${item.color}10,transparent 65%)`,
                  }}
                />

                {/* Tag badge */}
                <div
                  className="absolute top-4 right-4 z-10 px-2.5 py-1 font-mono text-[0.52rem] tracking-[2px] uppercase rounded-full border"
                  style={{
                    color: item.color,
                ...
                <div className="relative z-10 px-8 pb-8">
                  <h3
                    className="font-cinzel text-lg tracking-[2px] mb-2"
                    style={{ color: theme.text }}
                  >
                    {item.name}
                  </h3>
                  <p
                    className="text-[0.95rem] leading-[1.7] font-light mb-6 line-clamp-2"
                  ...
                  {item.sizes && (
                    <div className="flex gap-2 flex-wrap mb-6">
                      {item.sizes.map((s) => (
                        <span
                          key={s}
                          className="px-3 py-1 font-mono text-[0.56rem] tracking-[1px] border rounded"
                          style={{
                            color: theme.textDim,
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <span
                        ...
                        style={{ color: item.priceColor || item.color }}
                      >
                        ₹{item.price}
                      </span>
                    </div>
        ...
        >
          <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              ...
              ["♻️", "Eco Packaging", "Sustainable materials"],
              ...
              <div key={title}>
                ...
                <div
                  className="font-mono text-[0.58rem] tracking-[1px]"
        ...
        {selected && (
          ...
          >
            ...
            >
              <button
                onClick={() => setSelected(null)}
                className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center border cursor-none text-sm transition-all"
              ...
              />
              <h2
                className="font-cinzel text-xl text-center tracking-wider mb-1"
                style={{ color: theme.text }}
              >
                {selected.name}
              </h2>
              <p
                className="font-mono text-[0.6rem] text-center tracking-[2px] mb-4"
              ...
              {selected.sizes && (
                <div className="mb-5">
                  <div
                    className="font-mono text-[0.58rem] tracking-[2px] uppercase mb-2"
                    style={{ color: theme.textDim }}
                  >
                    Available Sizes
                  </div>
                  <div className="flex gap-2 flex-wrap">
                    {selected.sizes.map((s) => (
                      <span
                        key={s}
                        className="px-3 py-1.5 font-mono text-[0.6rem] border cursor-none hover:border-current transition-colors"
                        style={{
              ...
              <div className="flex items-center justify-between">
                <span
                  className="font-cinzel text-2xl"
                  style={{ color: selected.priceColor || selected.color }}
                >
                  ₹{selected.price}
                </span>
                <motion.button
                  ...
                  whileTap={{ scale: 0.96 }}
                  onClick={() => {
                    window.open(selected.registrationLink, "_blank");
                    setSelected(null);
                  }}
