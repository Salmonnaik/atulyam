        ...
        <section className="py-20 px-6">
          <div className="max-w-6xl mx-auto">
            <motion.div {...fade(0.2)} className="text-center mb-16">
              ...
              >
                Experience the magic of live performances by renowned artists from 
                across the country. From soulful melodies to electrifying beats, 
                our Hall of Attraction promises an unforgettable musical journey.
              </p>
            </motion.div>
