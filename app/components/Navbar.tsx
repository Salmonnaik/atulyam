...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <Link
        href="/"
        className="font-cinzel text-[0.95rem] tracking-[4px] no-underline cursor-none"
      ...
      <div className="lg:hidden flex items-center gap-3">
        <ThemeSwitcher />
        <button
          className="flex flex-col gap-[5px] cursor-none bg-transparent border-none"
      ...
      {open && (
        <div
          className="absolute top-full left-0 right-0 py-5 lg:hidden"
          style={{
